...
<div class="control">
	<!-- <button type="button" title="Exit fullscreen" on:click={screen}>
	...
	<button type="button" title="Turn camera off/on" on:click={vI}>
		{#if vi}
	...
	<button type="button" title="Unmute/mute" on:click={aU}>
		{#if au}
			<svg viewBox="0 0 640 512">
				<path
	...
	<button type="button" title="Share screen" on:click={sS}>
		<svg viewBox="0 0 576 512">
			<path
	...
	<button type="button" title="Show/hide users" on:click={uL}>
		{#if ul}
			<svg viewBox="0 0 640 512">
				<path
	...
	<button type="button" title="Show/hide text message" on:click={mE}>
		{#if me}
	...
	<button type="button" title="Background blur" on:click={bB}>
		{#if bb}
	...
	<button type="button" title="Background replacement" on:click={bR}>
		{#if br}
			<svg viewBox="0 0 576 512">
				<path
	...
	<!-- <button type="button" title="Noise suppression" on:click={nS}>
		{#if ns}
			<svg viewBox="0 0 24 24">
				<path
	...
	<button type="button" id="ue" on:click={eX}>
		<svg viewBox="0 0 512 512">
			<path
